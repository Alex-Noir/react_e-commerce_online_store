...
import { StyledDivAbout } from '../../styles'
...
export default class About extends Component {
  ...
  render() {
    return (
      <StyledDivAbout className="w-auto bg-light rounded p-5">
        <p>
          <img src={require('../../../img/logo.webp')} alt="logo" className="img-tumbnail m-3 float-left"/>
          Alimazon company is the largest company in the world! After we've bought Google, Facebook, Apple and Microsoft there are no rivals left for us :) Ah, this sweet sweet taste of monopoly... we can do whatever we want and people still will give us their money! :) <br/> <br/>
        ...
        <p>
          ...
          The CEO of Alimazon is Mr. John Doe - he is the richest man in the world! He is also the most successful businessman alive! Nobody knows whether he pays his taxes, but you gotta admit - he looks damn good in that suit. ;) <br/> <br/>
